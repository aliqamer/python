...
class VPC:
    ...
    def attach_igw_to_vpc(self, vpc_id, igw_id):
        print('Attaching Internet GW ' + igw_id + ' to VPC '+vpc_id)
    ...
    def create_subnet(self, vpc_id, cidr_block):
        print('Creating a subnet for VPC' +
              vpc_id + ' with CIDR Block '+cidr_block)
    ...
    def allow_auto_assign_ip_addresses_for_subnet(self, subnet_id):
        print('Auto assigning ip address for subnet '+subnet_id)
